...
path1='C:/Users/mayij/Desktop/DOC/DCP2020/COVID19/STREET CLOSURE/'
path2='C:/Users/Yijun Ma/Desktop/D/DOCUMENT/DCP2019/ONSTPARKING/'



school=gpd.read_file(path1+'openlearning/Public_Schools_Points_2011-2012A.shp')
school=school.to_crs('epsg:4326')



syo=pd.read_excel(path1+'openlearning/OL.MasterApprovals.xlsx',sheet_name='School Yard Only',dtype=str)
